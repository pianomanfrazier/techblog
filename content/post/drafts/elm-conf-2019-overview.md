...
As a first easy attempt at testing its accesibility she turned off all CSS styling.
...
She rewrote the tests in elm-program-test a new integrated testing library. She also wrote `tesk9/accessible-html`. This package will check if you are violating accessible principles in the markup like attaching events to non-clickable elements like `<div>` or `<span>`.
...
I go through my music app that I am building. I have written about it in my other posts [here](/post/music-theory-in-elm) and [here](/post/theory-app-prototypes).
...
She drew inspiration from the old Mario Teaches Typing game. She built a piano key drilling app that had similar mechanics.
...
> Xenos paradox you will never reach the destination, but because
...
There were some **Awesome demos** in this talk demonstrating lots of objects and animations in 3D. The package is not yet in the Elm packages but will hopefully be there soon.
